...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        # Ganti 'nama_dari_golang' dengan variabel yang berisi nama hasil pengenalan dari Golang
        nama_dari_golang = "reza"
        cv2.putText(frame, 'Nama: {}'.format(nama_dari_golang), (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
